<?php
	$objQuery = $db->Query(APP_TABLES_PREFIX . 'manga_titles','*');
	...
	$objQuery = $db->Query(APP_TABLES_PREFIX . 'manga_titles','*',null,null,null,array('datetime_post'=>'DESC'),array('offset'=>$Page_Start,'rows'=>$Per_Page));
?>
<div class="page-header">
	<h2 class="page-header">รายชื่อการ์ตูนทั้งหมด <?php echo $Num_Rows;?> เรื่อง</h2>
</div>
<div class="row">
...
<div class="text-center">
	<ul class="pagination">
		<?php
			...
			$pages->url_next = $_SERVER["PHP_SELF"]."?action=all-manga&Page=";
